...
using String = cms::StaticString<8>;
...
static_assert(
    !std::is_constructible<String, cms::StringView>::value,
    "StringView construction is intentionally unsupported");
static_assert(
    !std::is_constructible<cms::StaticString<16>, const String&>::value,
    "Cross-capacity copy construction is intentionally unsupported");
static_assert(
    !std::is_assignable<cms::StaticString<16>&, const String&>::value,
    "Cross-capacity copy assignment is intentionally unsupported");
static_assert(sizeof(cms::StaticString<1>) > 0, "StorageBytes == 1 must compile");
...
static_assert(
    std::is_same<decltype(std::declval<const String&>().view()), cms::StringView>::value,
    "view has the wrong return type");
static_assert(
    std::is_same<decltype(std::declval<String&>().buffer()), cms::StringBuffer>::value,
...
static_assert(
    std::is_same<
        decltype(std::declval<String&>().assign(std::declval<cms::StringView>())),
        cms::WriteResult>::value,
    "assign has the wrong return type");
static_assert(
    std::is_same<
        decltype(std::declval<String&>().append(std::declval<cms::StringView>())),
        cms::WriteResult>::value,
    "append has the wrong return type");
static_assert(
    std::is_same<
        decltype(std::declval<String&>().assignTruncated(
            std::declval<cms::StringView>())),
        cms::WriteResult>::value,
...
static_assert(
    noexcept(std::declval<String&>().assign(std::declval<cms::StringView>())),
    "assign must be noexcept");
static_assert(
    noexcept(std::declval<String&>().append(std::declval<cms::StringView>())),

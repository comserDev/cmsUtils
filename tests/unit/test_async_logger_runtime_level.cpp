...
int main() {
    ...
    CMS_TEST_CHECK(logger.log(cms::log::Level::trace, "filtered")
        == cms::Status::ok);
    ...
    CMS_TEST_CHECK(logger.log(
        cms::log::Level::debug,
        cms::StringView(oversized, sizeof(oversized))) == cms::Status::ok);
    CMS_TEST_CHECK(clockState.calls == 0);
    ...
    logger.setMinLevel(cms::log::Level::error);
    ...
    CMS_TEST_CHECK(logger.log(cms::log::Level::warning, "first")
        == cms::Status::ok);
    clockState.current = 12;
    CMS_TEST_CHECK(logger.log(cms::log::Level::error, "second")
        == cms::Status::ok);
    clockState.current = 13;
    CMS_TEST_CHECK(logger.log(cms::log::Level::critical, "third")
        == cms::Status::ok);
    ...
    CMS_TEST_CHECK(logger.log(cms::log::Level::debug, "ignored")
        == cms::Status::ok);
    ...
    CMS_TEST_CHECK(logger.log(cms::log::Level::warning, "enabled-again")
        == cms::Status::ok);
    CMS_TEST_CHECK(logger.drainOne() == cms::Status::ok);
    ...
    using NullRuntimeLevelLogger = cms::log::AsyncLogger<
        16,
        1,
        CountingClock,
        CapturingSink,
    ...
    nullLogger.setMinLevel(cms::log::Level::error);
    CMS_TEST_CHECK(nullLogger.log(cms::log::Level::info, "hidden")
        == cms::Status::ok);
    CMS_TEST_CHECK(nullClockState.calls == 0);
    nullClockState.current = 30;
    CMS_TEST_CHECK(nullLogger.log(cms::log::Level::error, "shown")
        == cms::Status::ok);
    CMS_TEST_CHECK(nullLogger.drainOne() == cms::Status::ok);
    checkLine(nullSinkState, 0, "[30] [ERROR] shown\n");

    using AnsiRuntimeLevelLogger = cms::log::AsyncLogger<
        16,
        1,
        CountingClock,
        CapturingSink,
    ...
    ansiLogger.setMinLevel(cms::log::Level::warning);
    CMS_TEST_CHECK(ansiLogger.log(cms::log::Level::debug, "hidden")
        == cms::Status::ok);
    ansiClockState.current = 40;
    CMS_TEST_CHECK(ansiLogger.log(cms::log::Level::warning, "shown")
        == cms::Status::ok);
    CMS_TEST_CHECK(ansiLogger.drainOne() == cms::Status::ok);
    checkLine(
        ansiSinkState,
        0,
    ...
    using MeasuredAnsiLogger = cms::log::AsyncLogger<
        ...
        cms::sync::NullMutex,
        cms::log::AnsiFormatter>;
    using MeasuredRuntimeAnsiLogger = cms::log::AsyncLogger<
        64,
        8,
        CountingClock,
        CapturingSink,
    ...
    using MeasuredRuntimeLevelPlainLogger = cms::log::AsyncLogger<
        64,
        8,
        CountingClock,
        CapturingSink,
        ...
        cms::log::PlainFormatter,
        cms::log::RuntimeLevelFilter>;
    using MeasuredRuntimeLevelAnsiLogger = cms::log::AsyncLogger<
        64,
        8,
        CountingClock,
        CapturingSink,
        ...
        cms::log::AnsiFormatter,
        cms::log::RuntimeLevelFilter>;
    using MeasuredRuntimeBothLogger = cms::log::AsyncLogger<
        64,
        8,
        CountingClock,
        CapturingSink,
    ...
    std::printf("sizeof(cms::log::StaticRecord<64>)=%zu\n",
        sizeof(MeasuredRecord));
    std::printf("sizeof(cms::StaticQueue<StaticRecord<64>, 8>)=%zu\n",

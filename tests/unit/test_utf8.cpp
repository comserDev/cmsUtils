...
void checkValidDecode(
    ...
    char32_t codePoint,
    std::size_t bytes) {
    const cms::util::utf8::DecodeResult result = cms::util::utf8::decodeNext(input, 0);
...
void checkInvalidDecode(cms::util::StringView input) {
    const cms::util::utf8::DecodeResult result = cms::util::utf8::decodeNext(input, 0);
    CMS_TEST_CHECK(result.status == cms::util::Status::invalid_utf8);
    CMS_TEST_CHECK(result.codePoint == static_cast<char32_t>(0xFFFD));
    CMS_TEST_CHECK(result.bytes == 1);
    CMS_TEST_CHECK(cms::util::utf8::validate(input) == cms::util::Status::invalid_utf8);
}
...
void checkCount(
    ...
    const cms::util::ParseResult<std::size_t> result = cms::util::utf8::count(input);
    CMS_TEST_CHECK(result.status == cms::util::Status::ok);
...
void checkSubstring(
    ...
    const cms::util::WriteResult result =
        cms::util::utf8::substring(input, first, count, output);
    CMS_TEST_REQUIRE(result.status == cms::util::Status::ok);
...
void checkSanitize(
    ...
    const cms::util::WriteResult result = cms::util::utf8::sanitize(input, output);
    CMS_TEST_REQUIRE(result.status == cms::util::Status::ok);
    CMS_TEST_CHECK(result.written == expectedSize);
    CMS_TEST_CHECK(result.required == expectedSize);
    CMS_TEST_REQUIRE(output.valid());
...
int main() {
    ...
    checkValidDecode(cms::util::StringView(ascii, sizeof(ascii)), U'A', 1);
    checkValidDecode(cms::util::StringView(cent, sizeof(cent)), 0x00A2, 2);
    checkValidDecode(cms::util::StringView(korean, sizeof(korean)), 0xAC00, 3);
    checkValidDecode(cms::util::StringView(emoji, sizeof(emoji)), 0x1F600, 4);
    ...
    checkValidDecode(cms::util::StringView(u007f, sizeof(u007f)), 0x007F, 1);
    checkValidDecode(cms::util::StringView(u0080, sizeof(u0080)), 0x0080, 2);
    checkValidDecode(cms::util::StringView(u07ff, sizeof(u07ff)), 0x07FF, 2);
    checkValidDecode(cms::util::StringView(u0800, sizeof(u0800)), 0x0800, 3);
    checkValidDecode(cms::util::StringView(ud7ff, sizeof(ud7ff)), 0xD7FF, 3);
    checkValidDecode(cms::util::StringView(ue000, sizeof(ue000)), 0xE000, 3);
    checkValidDecode(cms::util::StringView(uffff, sizeof(uffff)), 0xFFFF, 3);
    checkValidDecode(cms::util::StringView(u10000, sizeof(u10000)), 0x10000, 4);
    checkValidDecode(cms::util::StringView(u10ffff, sizeof(u10ffff)), 0x10FFFF, 4);

    CMS_TEST_CHECK(cms::util::utf8::validate(cms::util::StringView()) == cms::util::Status::ok);
    CMS_TEST_CHECK(
        cms::util::utf8::validate(cms::util::StringView(mixed, sizeof(mixed)))
        == cms::util::Status::ok);
    CMS_TEST_CHECK(
        cms::util::utf8::validate(cms::util::StringView(embeddedNul, sizeof(embeddedNul)))
        == cms::util::Status::ok);
    ...
    checkInvalidDecode(cms::util::StringView(
        isolatedContinuation, sizeof(isolatedContinuation)));
    checkInvalidDecode(cms::util::StringView(c0, sizeof(c0)));
    checkInvalidDecode(cms::util::StringView(c1, sizeof(c1)));
    checkInvalidDecode(cms::util::StringView(overlongTwo, sizeof(overlongTwo)));
    checkInvalidDecode(cms::util::StringView(overlongThree, sizeof(overlongThree)));
    checkInvalidDecode(cms::util::StringView(overlongFour, sizeof(overlongFour)));
    checkInvalidDecode(cms::util::StringView(truncatedTwo, sizeof(truncatedTwo)));
    checkInvalidDecode(cms::util::StringView(truncatedThree, sizeof(truncatedThree)));
    checkInvalidDecode(cms::util::StringView(truncatedFour, sizeof(truncatedFour)));
    checkInvalidDecode(cms::util::StringView(surrogateLower, sizeof(surrogateLower)));
    checkInvalidDecode(cms::util::StringView(
        surrogateInterior, sizeof(surrogateInterior)));
    checkInvalidDecode(cms::util::StringView(surrogateUpper, sizeof(surrogateUpper)));
    checkInvalidDecode(cms::util::StringView(aboveMaximum, sizeof(aboveMaximum)));
    checkInvalidDecode(cms::util::StringView(f5, sizeof(f5)));
    checkInvalidDecode(cms::util::StringView(ff, sizeof(ff)));
    checkInvalidDecode(cms::util::StringView(malformedTwo, sizeof(malformedTwo)));
    checkInvalidDecode(cms::util::StringView(
    ...
    const cms::util::utf8::DecodeResult atEnd =
        cms::util::utf8::decodeNext(cms::util::StringView(ascii, sizeof(ascii)), 1);
    CMS_TEST_CHECK(atEnd.status == cms::util::Status::out_of_range);
    CMS_TEST_CHECK(atEnd.codePoint == 0);
    CMS_TEST_CHECK(atEnd.bytes == 0);
    const cms::util::utf8::DecodeResult pastEnd =
        cms::util::utf8::decodeNext(cms::util::StringView(ascii, sizeof(ascii)), 2);
    CMS_TEST_CHECK(pastEnd.status == cms::util::Status::out_of_range);
    CMS_TEST_CHECK(pastEnd.codePoint == 0);
    CMS_TEST_CHECK(pastEnd.bytes == 0);

    checkCount(cms::util::StringView(), 0, 0);
    const char asciiText[] = {'A', 'B', 'C'};
    checkCount(cms::util::StringView(asciiText, sizeof(asciiText)), 3, 3);
    const char koreanText[] = {
        byte(0xEA), byte(0xB0), byte(0x80),
        byte(0xEB), byte(0x82), byte(0x98)};
    checkCount(cms::util::StringView(koreanText, sizeof(koreanText)), 2, 6);
    checkCount(cms::util::StringView(emoji, sizeof(emoji)), 1, 4);
    checkCount(cms::util::StringView(mixed, sizeof(mixed)), 4, sizeof(mixed));
    checkCount(
        cms::util::StringView(embeddedNul, sizeof(embeddedNul)),
        3,
        sizeof(embeddedNul));

    const char invalidAfterAscii[] = {'A', byte(0xE2), byte(0x82)};
    const cms::util::ParseResult<std::size_t> invalidCount =
        cms::util::utf8::count(cms::util::StringView(
            invalidAfterAscii,
            sizeof(invalidAfterAscii)));
    CMS_TEST_CHECK(invalidCount.status == cms::util::Status::invalid_utf8);
    CMS_TEST_CHECK(invalidCount.value == 1);
    CMS_TEST_CHECK(invalidCount.consumed == 1);

    const char expectedBc[] = {'B', 'C'};
    checkSubstring(
        cms::util::StringView(asciiText, sizeof(asciiText)),
        1,
        100,
        expectedBc,
        sizeof(expectedBc));
    ...
    checkSubstring(
        cms::util::StringView(koreanText, sizeof(koreanText)),
        1,
        1,
        secondKorean,
        sizeof(secondKorean));
    checkSubstring(
        cms::util::StringView(emoji, sizeof(emoji)),
        0,
        1,
        emoji,
        sizeof(emoji));
    ...
    checkSubstring(
        cms::util::StringView(mixed, sizeof(mixed)),
        1,
        2,
        mixedMiddle,
        sizeof(mixedMiddle));
    ...
    cms::util::StringBuffer outOfRangeOutput(
        outOfRangeStorage,
        sizeof(outOfRangeStorage),
        outOfRangeSize);
    const cms::util::WriteResult outOfRangeResult = cms::util::utf8::substring(
        cms::util::StringView(asciiText, sizeof(asciiText)),
        4,
        1,
        outOfRangeOutput);
    CMS_TEST_CHECK(outOfRangeResult.status == cms::util::Status::out_of_range);
    ...
    cms::util::StringBuffer exactSubstringOutput(
        exactSubstringStorage,
        sizeof(exactSubstringStorage),
        exactSubstringSize);
    const cms::util::WriteResult exactSubstring = cms::util::utf8::substring(
        cms::util::StringView(emoji, sizeof(emoji)),
        0,
        1,
        exactSubstringOutput);
    CMS_TEST_CHECK(exactSubstring.status == cms::util::Status::ok);
    ...
    cms::util::StringBuffer shortSubstringOutput(
        shortSubstringStorage,
        sizeof(shortSubstringStorage),
        shortSubstringSize);
    const cms::util::WriteResult shortSubstring = cms::util::utf8::substring(
        cms::util::StringView(emoji, sizeof(emoji)),
        0,
        1,
        shortSubstringOutput);
    CMS_TEST_CHECK(shortSubstring.status == cms::util::Status::no_space);
    ...
    cms::util::StringBuffer invalidSubstringOutput(
        invalidSubstringStorage,
        sizeof(invalidSubstringStorage),
        invalidSubstringSize);
    const cms::util::WriteResult invalidSubstring = cms::util::utf8::substring(
        cms::util::StringView(invalidAfterAscii, sizeof(invalidAfterAscii)),
        0,
        1,
        invalidSubstringOutput);
    CMS_TEST_CHECK(invalidSubstring.status == cms::util::Status::invalid_utf8);
    ...
    const cms::util::WriteResult invalidBeforeSubstring = cms::util::utf8::substring(
        cms::util::StringView(
        ...
        invalidSubstringOutput);
    CMS_TEST_CHECK(
        invalidBeforeSubstring.status == cms::util::Status::invalid_utf8);
    ...
    const cms::util::WriteResult defaultSubstring = cms::util::utf8::substring(
        cms::util::StringView(asciiText, sizeof(asciiText)),
        0,
        1,
        defaultOutput);
    CMS_TEST_CHECK(defaultSubstring.status == cms::util::Status::invalid_argument);
    ...
    const cms::util::WriteResult damagedSubstring = cms::util::utf8::substring(
        cms::util::StringView(asciiText, sizeof(asciiText)),
        0,
        1,
        damagedOutput);
    CMS_TEST_CHECK(damagedSubstring.status == cms::util::Status::invalid_argument);
    ...
    checkSanitize(cms::util::StringView(mixed, sizeof(mixed)), mixed, sizeof(mixed));
    ...
    const char replacementThree[] = {
        ...
        byte(0xEF), byte(0xBF), byte(0xBD)};
    checkSanitize(
        cms::util::StringView(isolatedContinuation, sizeof(isolatedContinuation)),
        replacementOne,
        sizeof(replacementOne));
    const char consecutiveInvalid[] = {byte(0x80), byte(0xFF)};
    checkSanitize(
        cms::util::StringView(consecutiveInvalid, sizeof(consecutiveInvalid)),
        replacementTwo,
        sizeof(replacementTwo));
    checkSanitize(
        cms::util::StringView(overlongTwo, sizeof(overlongTwo)),
        replacementTwo,
        sizeof(replacementTwo));
    checkSanitize(
        cms::util::StringView(truncatedThree, sizeof(truncatedThree)),
        replacementTwo,
        sizeof(replacementTwo));
    checkSanitize(
        cms::util::StringView(surrogateLower, sizeof(surrogateLower)),
        replacementThree,
    ...
    checkSanitize(
        cms::util::StringView(validInvalidValid, sizeof(validInvalidValid)),
        sanitizedMiddle,
    ...
    cms::util::StringBuffer exactSanitizeOutput(
        exactSanitizeStorage,
        sizeof(exactSanitizeStorage),
        exactSanitizeSize);
    const cms::util::WriteResult exactSanitize = cms::util::utf8::sanitize(
        cms::util::StringView(isolatedContinuation, sizeof(isolatedContinuation)),
        exactSanitizeOutput);
    CMS_TEST_CHECK(exactSanitize.status == cms::util::Status::ok);
    ...
    CMS_TEST_CHECK(
        cms::util::utf8::validate(exactSanitizeOutput.view()) == cms::util::Status::ok);

    char shortSanitizeStorage[3] = "x";
    std::size_t shortSanitizeSize = 1;
    cms::util::StringBuffer shortSanitizeOutput(
        shortSanitizeStorage,
        sizeof(shortSanitizeStorage),
        shortSanitizeSize);
    const cms::util::WriteResult shortSanitize = cms::util::utf8::sanitize(
        cms::util::StringView(isolatedContinuation, sizeof(isolatedContinuation)),
        shortSanitizeOutput);
    CMS_TEST_CHECK(shortSanitize.status == cms::util::Status::no_space);
    ...
    const cms::util::WriteResult defaultSanitize = cms::util::utf8::sanitize(
        cms::util::StringView(asciiText, sizeof(asciiText)),
        defaultOutput);
    CMS_TEST_CHECK(defaultSanitize.status == cms::util::Status::invalid_argument);
    CMS_TEST_CHECK(defaultSanitize.written == 0);
    CMS_TEST_CHECK(defaultSanitize.required == 0);

    const cms::util::WriteResult damagedSanitize = cms::util::utf8::sanitize(
        cms::util::StringView(asciiText, sizeof(asciiText)),
        damagedOutput);
    CMS_TEST_CHECK(damagedSanitize.status == cms::util::Status::invalid_argument);
    ...
    std::printf(
        ...
        sizeof(cms::util::utf8::DecodeResult));
